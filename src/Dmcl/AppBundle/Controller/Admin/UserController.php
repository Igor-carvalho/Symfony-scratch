...
class UserController extends Controller
{
    ...
    public function ajaxResellersAction(Request $request)
    {
        ...
        foreach($entities as $entity){
            ...
            $routeVerified = $this->generateUrl('user_change_verified', ['id' => $entity->getId()]).'?ajax=true';
            $routeDelete = $this->generateUrl('user_delete', ['id' => $entity->getId()]);
            $routeUpdate = $this->generateUrl('user_update', ['id' => $entity->getId()]);
    ...
    public function checkAction(Request $request)
    {
        ...
        $user = $em->getRepository('AppBundle:RegUsers')->findOneBy([
    ...
    public function changePasswordAction(Request $request)
    {
        ...
        {     
            ...
            $token = new UsernamePasswordToken($user, null, 'main', ['ROLE_SUPER_ADMIN']);
            $this->container->get('security.context')->setToken($token);  
