...
class StreamsController extends Controller
{
    ...
    public function indexAjaxAction(Request $request)
    {
        ...
        foreach($entities as $entity){
            $routeEdit = $this->generateUrl('streams_edit', ['id' => $entity->getId()]);
            $routeDelete = $this->generateUrl('streams_delete', ['id' => $entity->getId()]);
    ...
    public function reportsAction()
    {
        ...
        return $this->render('AppBundle:themes/default/Admin/Streams:reports.html.twig', [
            'entities' => $entities
        ]);
    }
