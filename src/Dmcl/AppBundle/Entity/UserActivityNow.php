 ...
 * UserActivityNow
 *
 * @ORM\Table(name="user_activity_now", indexes={@ORM\Index(name="user_id", columns={"user_id"}), @ORM\Index(name="stream_id", columns={"stream_id"}), @ORM\Index(name="server_id", columns={"server_id"}), @ORM\Index(name="container", columns={"container"}), @ORM\Index(name="pid", columns={"pid"}), @ORM\Index(name="date_end", columns={"date_end"}), @ORM\Index(name="geoip_country_code", columns={"geoip_country_code"}), @ORM\Index(name="user_agent", columns={"user_agent"}), @ORM\Index(name="user_agent_2", columns={"user_agent"}), @ORM\Index(name="user_ip", columns={"user_ip"}), @ORM\Index(name="date_start", columns={"date_start"}), @ORM\Index(name="hls_end", columns={"hls_end"})})
 * @ORM\Entity
 */
class UserActivityNow
{
     ...
     * @var integer
     *
     * @ORM\Column(name="hls_last_read", type="integer", nullable=true)
     */
    private $hlsLastRead;
     ...
     * @var boolean
     *
     * @ORM\Column(name="hls_end", type="boolean", nullable=false)
     */
    private $hlsEnd = '0';
     ...
     * Set hlsLastRead
     *
     * @param integer $hlsLastRead
     *
     * @return UserActivityNow
     */
    public function setHlsLastRead($hlsLastRead)
    {
        $this->hlsLastRead = $hlsLastRead;
     ...
     * @return integer
     */
    public function getHlsLastRead()
    {
        return $this->hlsLastRead;
    }

    /**
     * Set hlsEnd
     *
     * @param boolean $hlsEnd
     *
     * @return UserActivityNow
     */
    public function setHlsEnd($hlsEnd)
    {
        $this->hlsEnd = $hlsEnd;
