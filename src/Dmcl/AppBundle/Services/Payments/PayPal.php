...
class PayPal
{
    ...
    protected function curlPost($encoded_data) {
        ...
        if ($this->response === false || $this->response_status == '0') {
            ...
            $errstr = curl_error($ch);
             throw new HttpException($errno, $errstr);
        }
    }
    ...
    public function processIpn($post_data=null) { 
        ...
        if ($post_data === null) {
            ...
            if (!empty($_POST)) {
                ...
                $encoded_data .= '&' . file_get_contents('php://input');
                   ...
                   throw new HttpException(500,"No POST data found.");
            }
        } else {
        ...
        if (strpos($this->response_status, '200') === false) {
            throw new HttpException(500,"Invalid response status: " . $this->response_status);
        }
        ...
        if (strpos($this->response, "VERIFIED") !== false) {
            ...
            throw new HttpException(500,"Unexpected response from PayPal.");
        }
