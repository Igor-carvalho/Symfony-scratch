 ...
 */
class Signals extends \Dmcl\AppBundle\Entity\Signals implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Signals' . "\0" . 'signalId', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Signals' . "\0" . 'pid', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Signals' . "\0" . 'rtmp', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Signals' . "\0" . 'time', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Signals' . "\0" . 'server'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Signals $proxy) {
    ...
    public function getSignalId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getSignalId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSignalId', []);

        return parent::getSignalId();
    }
    ...
    public function setRtmp($rtmp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRtmp', [$rtmp]);

        return parent::setRtmp($rtmp);
    }
    ...
    public function getRtmp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRtmp', []);

        return parent::getRtmp();
    }
