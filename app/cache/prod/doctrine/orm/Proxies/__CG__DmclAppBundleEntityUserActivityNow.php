 ...
 */
class UserActivityNow extends \Dmcl\AppBundle\Entity\UserActivityNow implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'activityId', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'userAgent', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'userIp', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'container', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'pid', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'dateStart', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'dateEnd', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'geoipCountryCode', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'isp', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'externalDevice', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'divergence', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'hlsLastRead', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'hlsEnd', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'user', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'stream', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserActivityNow' . "\0" . 'server'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserActivityNow $proxy) {
    ...
    public function setHlsLastRead($hlsLastRead)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHlsLastRead', [$hlsLastRead]);

        return parent::setHlsLastRead($hlsLastRead);
    }
    ...
    public function getHlsLastRead()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHlsLastRead', []);

        return parent::getHlsLastRead();
    }
    ...
    public function setHlsEnd($hlsEnd)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHlsEnd', [$hlsEnd]);

        return parent::setHlsEnd($hlsEnd);
    }
    ...
    public function getHlsEnd()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHlsEnd', []);

        return parent::getHlsEnd();
    }
