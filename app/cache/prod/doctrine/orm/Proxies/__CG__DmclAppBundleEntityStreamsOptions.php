 ...
 */
class StreamsOptions extends \Dmcl\AppBundle\Entity\StreamsOptions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsOptions' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsOptions' . "\0" . 'value', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsOptions' . "\0" . 'stream', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsOptions' . "\0" . 'argument'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StreamsOptions $proxy) {
    ...
    public function setArgument(\Dmcl\AppBundle\Entity\StreamsArguments $argument = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setArgument', [$argument]);
    ...
    public function getArgument()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getArgument', []);
