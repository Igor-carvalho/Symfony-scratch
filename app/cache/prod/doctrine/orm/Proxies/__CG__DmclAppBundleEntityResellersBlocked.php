 ...
 */
class ResellersBlocked extends \Dmcl\AppBundle\Entity\ResellersBlocked implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\ResellersBlocked' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\ResellersBlocked' . "\0" . 'reseller', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\ResellersBlocked' . "\0" . 'reason'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResellersBlocked $proxy) {
