 ...
 */
class IspAddon extends \Dmcl\AppBundle\Entity\IspAddon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\IspAddon' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\IspAddon' . "\0" . 'isp', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\IspAddon' . "\0" . 'blocked'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IspAddon $proxy) {
