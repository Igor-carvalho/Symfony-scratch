 ...
 */
class MagLogs extends \Dmcl\AppBundle\Entity\MagLogs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MagLogs' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MagLogs' . "\0" . 'action', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MagLogs' . "\0" . 'mag'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MagLogs $proxy) {
