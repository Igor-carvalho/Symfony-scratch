 ...
 */
class MediaStatistics extends \Dmcl\AppBundle\Entity\MediaStatistics implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MediaStatistics' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MediaStatistics' . "\0" . 'mediaType', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MediaStatistics' . "\0" . 'ipAddress', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MediaStatistics' . "\0" . 'country', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MediaStatistics' . "\0" . 'action', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\MediaStatistics' . "\0" . 'createdAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MediaStatistics $proxy) {
