...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber($this->get('vich_uploader.listener.clean.package_logo'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.clean.backups'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.inject.package_logo'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.remove.backups'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.inject.backups'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.remove.package_logo'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.upload.package_logo'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.upload.backups'));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '178.132.5.104', 'port' => 7999, 'dbname' => 'xtream_iptvpro', 'user' => 'mariaadash', 'password' => 'mariaa2909', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Dbal_XtreamcodeConnectionService()
    {
        ...
        $a->addEventSubscriber($this->get('vich_uploader.listener.upload.package_logo'));
        $a->addEventSubscriber($this->get('vich_uploader.listener.upload.backups'));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.xtreamcode_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.xtreamcode_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'xtreamcode', 'user' => 'xtreamcode', 'password' => 'xtreamcode', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000000f646f8300007fc192c407bb36a8dc77a7dc72fd8239fa4358e32210(
    ...
    public function getDoctrine_Orm_XtreamcodeEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.xtreamcode_entity_manager'] = new DoctrineORMEntityManager_000000000f646f8900007fc192c407bb36a8dc77a7dc72fd8239fa4358e32210(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_01fe4d68a4c4e7f4b5da4b80b819edc72e5cbe0ff3a0d581a2e31997178385d8');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_XtreamcodeMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_xtreamcode_01fe4d68a4c4e7f4b5da4b80b819edc72e5cbe0ff3a0d581a2e31997178385d8');
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => false, 'resource_files' => array('pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pl.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pt.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ar.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/src/Dmcl/StbBundle/Resources/translations/messages.fr.xlf'), 4 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.fr.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/validators.en.yml'), 4 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/messages.en.yml'), 5 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/FOSUserBundle.en.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.en.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.tr.yml')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.sl.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.it.yml')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.uk.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/messages.es.yml'), 4 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/validators.es.yml'), 5 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/FOSUserBundle.es.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.es.yml')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.de.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.hu.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/messages.ru.yml'), 4 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/FOSUserBundle.ru.yml'), 5 => ($this->targetDirs[3].'/src/Dmcl/AppBundle/Resources/translations/validators.ru.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ru.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'VichUploaderBundle:Form:fields.html.twig', 2 => 'AppBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'TFoxMpdfPortBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/tfox/mpdf-port-bundle/TFox/MpdfPortBundle'),
            ...
            'database_user' => 'xtreamcode',
            'database_password' => 'xtreamcode',
...
class DoctrineORMEntityManager_000000000f646f8300007fc192c407bb36a8dc77a7dc72fd8239fa4358e32210 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5bc2ebc0d9e37257417182 = null;
    private $initializer5bc2ebc0d9e58192541679 = null;
    private static $publicProperties5bc2ebc0d9de0518759091 = array(
        
    );
    public function getConnection()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getConnection', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getMetadataFactory', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getExpressionBuilder', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'beginTransaction', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getCache', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getCache();
    }
    public function transactional($func)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'transactional', array('func' => $func), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->transactional($func);
    }
    public function commit()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'commit', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->commit();
    }
    public function rollback()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'rollback', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getClassMetadata', array('className' => $className), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'createQuery', array('dql' => $dql), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'createNamedQuery', array('name' => $name), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'createQueryBuilder', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'flush', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'clear', array('entityName' => $entityName), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->clear($entityName);
    }
    public function close()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'close', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->close();
    }
    public function persist($entity)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'persist', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'remove', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'refresh', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'detach', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'merge', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'contains', array('entity' => $entity), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getEventManager', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getConfiguration', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'isOpen', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getUnitOfWork', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getProxyFactory', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'initializeObject', array('obj' => $obj), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'getFilters', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'isFiltersStateClean', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'hasFilters', array(), $this->initializer5bc2ebc0d9e58192541679);
        return $this->valueHolder5bc2ebc0d9e37257417182->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer5bc2ebc0d9e58192541679 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, '__get', array('name' => $name), $this->initializer5bc2ebc0d9e58192541679);
        if (isset(self::$publicProperties5bc2ebc0d9de0518759091[$name])) {
            return $this->valueHolder5bc2ebc0d9e37257417182->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0d9e37257417182;
    ...
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bc2ebc0d9e58192541679);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0d9e37257417182;
    ...
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, '__isset', array('name' => $name), $this->initializer5bc2ebc0d9e58192541679);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0d9e37257417182;
    ...
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, '__unset', array('name' => $name), $this->initializer5bc2ebc0d9e58192541679);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0d9e37257417182;
    ...
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, '__clone', array(), $this->initializer5bc2ebc0d9e58192541679);
        $this->valueHolder5bc2ebc0d9e37257417182 = clone $this->valueHolder5bc2ebc0d9e37257417182;
    }
    public function __sleep()
    {
        $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, '__sleep', array(), $this->initializer5bc2ebc0d9e58192541679);
        return array('valueHolder5bc2ebc0d9e37257417182');
    }
    ...
    {
        return $this->initializer5bc2ebc0d9e58192541679;
    }
    public function initializeProxy()
    {
        return $this->initializer5bc2ebc0d9e58192541679 && $this->initializer5bc2ebc0d9e58192541679->__invoke($this->valueHolder5bc2ebc0d9e37257417182, $this, 'initializeProxy', array(), $this->initializer5bc2ebc0d9e58192541679);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5bc2ebc0d9e37257417182;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5bc2ebc0d9e37257417182;
    }
}

class DoctrineORMEntityManager_000000000f646f8900007fc192c407bb36a8dc77a7dc72fd8239fa4358e32210 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5bc2ebc0e7eb5970940895 = null;
    private $initializer5bc2ebc0e7ecb628674214 = null;
    private static $publicProperties5bc2ebc0e7e75948315655 = array(
        
    );
    public function getConnection()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getConnection', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getMetadataFactory', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getExpressionBuilder', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'beginTransaction', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getCache', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getCache();
    }
    public function transactional($func)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'transactional', array('func' => $func), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->transactional($func);
    }
    public function commit()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'commit', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->commit();
    }
    public function rollback()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'rollback', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getClassMetadata', array('className' => $className), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'createQuery', array('dql' => $dql), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'createNamedQuery', array('name' => $name), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'createQueryBuilder', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'flush', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'clear', array('entityName' => $entityName), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->clear($entityName);
    }
    public function close()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'close', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->close();
    }
    public function persist($entity)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'persist', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'remove', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'refresh', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'detach', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'merge', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'contains', array('entity' => $entity), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getEventManager', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getConfiguration', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'isOpen', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getUnitOfWork', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getProxyFactory', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'initializeObject', array('obj' => $obj), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'getFilters', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'isFiltersStateClean', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'hasFilters', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return $this->valueHolder5bc2ebc0e7eb5970940895->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer5bc2ebc0e7ecb628674214 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, '__get', array('name' => $name), $this->initializer5bc2ebc0e7ecb628674214);
        if (isset(self::$publicProperties5bc2ebc0e7e75948315655[$name])) {
            return $this->valueHolder5bc2ebc0e7eb5970940895->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0e7eb5970940895;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bc2ebc0e7ecb628674214);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0e7eb5970940895;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, '__isset', array('name' => $name), $this->initializer5bc2ebc0e7ecb628674214);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0e7eb5970940895;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, '__unset', array('name' => $name), $this->initializer5bc2ebc0e7ecb628674214);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bc2ebc0e7eb5970940895;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, '__clone', array(), $this->initializer5bc2ebc0e7ecb628674214);
        $this->valueHolder5bc2ebc0e7eb5970940895 = clone $this->valueHolder5bc2ebc0e7eb5970940895;
    }
    public function __sleep()
    {
        $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, '__sleep', array(), $this->initializer5bc2ebc0e7ecb628674214);
        return array('valueHolder5bc2ebc0e7eb5970940895');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5bc2ebc0e7ecb628674214;
    }
    public function initializeProxy()
    {
        return $this->initializer5bc2ebc0e7ecb628674214 && $this->initializer5bc2ebc0e7ecb628674214->__invoke($this->valueHolder5bc2ebc0e7eb5970940895, $this, 'initializeProxy', array(), $this->initializer5bc2ebc0e7ecb628674214);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5bc2ebc0e7eb5970940895;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5bc2ebc0e7eb5970940895;
    }
}
