 ...
 */
class UserPaypal extends \Dmcl\AppBundle\Entity\UserPaypal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserPaypal' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserPaypal' . "\0" . 'paypalId', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\UserPaypal' . "\0" . 'userId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserPaypal $proxy) {
