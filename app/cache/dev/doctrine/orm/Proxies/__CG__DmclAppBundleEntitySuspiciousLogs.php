 ...
 */
class SuspiciousLogs extends \Dmcl\AppBundle\Entity\SuspiciousLogs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\SuspiciousLogs' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\SuspiciousLogs' . "\0" . 'data', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\SuspiciousLogs' . "\0" . 'lastUpdated', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\SuspiciousLogs' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SuspiciousLogs $proxy) {
