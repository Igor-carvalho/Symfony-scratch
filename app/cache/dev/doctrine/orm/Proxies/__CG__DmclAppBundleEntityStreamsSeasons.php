 ...
 */
class StreamsSeasons extends \Dmcl\AppBundle\Entity\StreamsSeasons implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsSeasons' . "\0" . 'seasonId', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsSeasons' . "\0" . 'seasonName', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\StreamsSeasons' . "\0" . 'stream'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StreamsSeasons $proxy) {
