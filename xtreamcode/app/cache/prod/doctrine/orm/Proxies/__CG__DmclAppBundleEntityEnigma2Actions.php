 ...
 */
class Enigma2Actions extends \Dmcl\AppBundle\Entity\Enigma2Actions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Enigma2Actions' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Enigma2Actions' . "\0" . 'type', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Enigma2Actions' . "\0" . 'key', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Enigma2Actions' . "\0" . 'command', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Enigma2Actions' . "\0" . 'command2', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Enigma2Actions' . "\0" . 'device'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Enigma2Actions $proxy) {
    ...
    public function setCommand2($command2)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCommand2', [$command2]);

        return parent::setCommand2($command2);
    }
    ...
    public function getCommand2()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommand2', []);

        return parent::getCommand2();
    }
