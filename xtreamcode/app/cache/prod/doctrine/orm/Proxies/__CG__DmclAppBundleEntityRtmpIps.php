 ...
 */
class RtmpIps extends \Dmcl\AppBundle\Entity\RtmpIps implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RtmpIps' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RtmpIps' . "\0" . 'ip', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RtmpIps' . "\0" . 'notes'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RtmpIps $proxy) {
