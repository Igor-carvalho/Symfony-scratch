 ...
 */
class RequestLogs extends \Dmcl\AppBundle\Entity\RequestLogs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RequestLogs' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RequestLogs' . "\0" . 'username', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RequestLogs' . "\0" . 'ipAddress', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RequestLogs' . "\0" . 'userAgent', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RequestLogs' . "\0" . 'route', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\RequestLogs' . "\0" . 'createAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestLogs $proxy) {
