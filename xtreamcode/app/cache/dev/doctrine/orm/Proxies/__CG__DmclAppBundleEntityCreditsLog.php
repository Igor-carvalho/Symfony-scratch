 ...
 */
class CreditsLog extends \Dmcl\AppBundle\Entity\CreditsLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\CreditsLog' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\CreditsLog' . "\0" . 'amount', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\CreditsLog' . "\0" . 'date', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\CreditsLog' . "\0" . 'reason', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\CreditsLog' . "\0" . 'target', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\CreditsLog' . "\0" . 'admin'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CreditsLog $proxy) {
