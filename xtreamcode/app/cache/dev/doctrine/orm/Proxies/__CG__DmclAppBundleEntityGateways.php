 ...
 */
class Gateways extends \Dmcl\AppBundle\Entity\Gateways implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'id', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'uniqueName', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'displayName', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'shopIdPublicKey', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'secretKey', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'enabled', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'updatedAt', '' . "\0" . 'Dmcl\\AppBundle\\Entity\\Gateways' . "\0" . 'orders'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gateways $proxy) {
