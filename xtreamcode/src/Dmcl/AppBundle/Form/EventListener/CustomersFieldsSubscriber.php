...
class CustomersFieldsSubscriber implements EventSubscriberInterface
{
    private $choices;

    /**
     * CustomersFieldsSubscriber constructor.
     *
     * @param $services
     */
    public function __construct($services, $ip)
    {
        ...
        $response = $services->sendRequest('customers/list', $ip);        
        ...
        if($response->data)
            foreach ($response->data as $customer){
                $this->choices[$customer->id] = $customer->name;
            }  
    }
