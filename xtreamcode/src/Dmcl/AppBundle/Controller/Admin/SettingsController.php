...
//        $a = $entity = $em->getRepository('AppBundle:Settings')->find(1);
//        print_r($this->getUser()->getId();exit;

        $entity = $em->getRepository('AppBundle:Settings')->findOneBy(array('user_id' => $this->getUser()->getId()));
    ...
    public function updateAction(Request $request) {
        ...
        $formsSettings = array('entity' => $entity,
