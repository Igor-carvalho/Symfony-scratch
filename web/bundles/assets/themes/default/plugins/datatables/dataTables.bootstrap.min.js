    ...
    "bootstrap_extended": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).append(
                ...
                '<input type="text" style="width: 35px;display: inline-block" class="pagination-panel-input form-control input-mini input-inline input-sm" maxlenght="5" style="text-align:center; margin: 0 5px;">' +
